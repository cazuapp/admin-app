...
import 'package:cazuapp_admin/views/users/main/final_search.dart';
...
class _SearchListState extends State<SearchList> {
    ...
    return BlocBuilder<UserSearchBloc, UserSearchState>(
      ...
      switch (state.status) {
        ...
        case UserSearchStatus.loading:
          return const Loader();
        case UserSearchStatus.failure:
          return const FailurePage(
              title: "Users list", subtitle: "Error loading users");
                          ...
                          child: Column(children: [
                            Padding(
                              ...
                              child: Container(
                                  ...
                                  child: const FinalUserSearchBar()),
                            ),
                            Padding(
                                padding: EdgeInsets.only(
                                    top: size.width * 0.03,
  ...
  void _onScroll() {
    if (_isBottom) {
      context.read<UserSearchBloc>().add(OnScroll());
    }
  }
