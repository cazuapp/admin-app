...
class FinalDriverSearchBar extends StatefulWidget {
  const FinalDriverSearchBar({super.key});

  @override
  State<FinalDriverSearchBar> createState() => _SearchBarState();
}

class _SearchBarState extends State<FinalDriverSearchBar> with SingleTickerProviderStateMixin {
    ...
    return FadeTransition(
      ...
      child: IconButton(
        ...
        onPressed: () {
          ...
          BlocProvider.of<DriverSearchBloc>(context).add(SearchReset());
        },
      ),
    );
  }
  ...
  void _handleSearchTextChange(BuildContext context, String text) {
    BlocProvider.of<DriverSearchBloc>(context).add(SearchReset());
    if (text.isNotEmpty) {
      BlocProvider.of<DriverSearchBloc>(context).add(SearchRequest(text: text));
    }
  }
}
