...
class FinalAdminSearchBar extends StatefulWidget {
  const FinalAdminSearchBar({super.key});

  @override
  State<FinalAdminSearchBar> createState() => _SearchBarState();
}

class _SearchBarState extends State<FinalAdminSearchBar> with SingleTickerProviderStateMixin {
