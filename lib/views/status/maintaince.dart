...
import 'package:cazuapp_admin/components/footer.dart';
...
class MaintForm extends StatefulWidget {
  const MaintForm({super.key});

  @override
  NoInternetState createState() => NoInternetState();
}

class NoInternetState extends State<MaintForm> {
      ...
      return SizedBox(
          ...
          child: ElevatedButton.icon(
              ...
              onPressed: () async {
                ...
                if (authbloc.instance.firstping.maint == false) {
    ...
    return BlocBuilder<AuthenticationBloc, AuthenticationState>(builder: (context, state) {
      return Scaffold(
          ...
          bottomNavigationBar: Container(
              ...
              child: Padding(
                padding: EdgeInsets.symmetric(horizontal: size.width * 0.05, vertical: size.height * 0.00),
                child: Row(
                              ...
                              children: [
                                Expanded(
                                    ...
                                    child: Column(
                                        ...
                                        crossAxisAlignment: CrossAxisAlignment.center,
                                        children: [
                                          const Icon(FontAwesomeIcons.wifi, size: 49, color: AppTheme.secondary),
                                          ...
                                          utext(
                                              align: Alignment.center,
                                              title: "We're sorry this situation is happening",
                                              textAlign: TextAlign.center,
                                              fontSize: 15,
                                              fontWeight: FontWeight.w400,
