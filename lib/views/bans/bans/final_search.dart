...
class FinalBanSearchBar extends StatefulWidget {
  const FinalBanSearchBar({super.key});

  @override
  State<FinalBanSearchBar> createState() => _SearchBarState();
}

class _SearchBarState extends State<FinalBanSearchBar> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<BanSearchBloc, BanSearchState>(
    ...
    return FadeTransition(
      ...
      child: IconButton(
        ...
        onPressed: () {
          ...
          BlocProvider.of<BanSearchBloc>(context).add(SearchReset());
        },
      ),
    );
  }
  ...
  void _handleSearchTextChange(BuildContext context, String text) {
    BlocProvider.of<BanSearchBloc>(context).add(SearchReset());
    if (text.isNotEmpty) {
      BlocProvider.of<BanSearchBloc>(context).add(SearchRequest(text: text));
    }
  }
}
