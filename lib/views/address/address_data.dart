...
import 'package:cazuapp_admin/views/address/address_update.dart';
import 'package:cazuapp_admin/views/address/delete_confirm.dart';
...
class AddressDataPage extends StatelessWidget {
  ...
  const AddressDataPage({required this.user, required this.id, super.key});
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
            create: (_) => AddressManagerBloc(instance: BlocProvider.of<AuthenticationBloc>(context).instance)
              ..add(SetBase(id: id, user: user, name: ""))
              ..add(const AddressAddressRequest())),
      ],
...
class AddressDataForm extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<AddressManagerBloc, AddressManagerState>(builder: (context, state) {
                                            ...
                                            Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                    builder: (context) => AddressInfoPage(
                                                        ...
                                                        title: "Name",
                                                        iconsrc: Icons.location_history_outlined,
                                                        value: state.address.name.value,
                                            ...
                                            Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                    builder: (context) => AddressInfoPage(
                                                        ...
                                                        title: "Address",
                                                        iconsrc: FontAwesomeIcons.locationArrow,
                                                        value: state.address.address.value,
                                                        type: LocalKeyEvent.address)))
                                          }),
                                  ItemExtended(
                                      input: "City",
                                            ...
                                            Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                    builder: (context) => AddressInfoPage(
                                                        ...
                                                        id: state.address.id,
                                                        title: "Options",
                                                        iconsrc: Icons.open_in_new_outlined,
                                                        value: state.address.options.value,
                                                        type: LocalKeyEvent.options)))
                                          }),
                                  ItemExtended(
                                      input: "Commentary",
                                            ...
                                            Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                    builder: (context) => AddressInfoPage(
                                                        ...
                                                        id: state.address.id,
                                                        title: "Commentary",
                                                        iconsrc: Icons.comment_bank_rounded,
                                                        value: state.address.commentary.value,
                                                        type: LocalKeyEvent.commentary)))
                                          }),
                                  ItemExtended(
                                    input: "Added",
                                    title: state.address.createdat,
                              ...
                              ItemDep(
                                  ...
                                  onTap: () => {
                                        Navigator.of(context).push(CupertinoPageRoute(
                                            builder: (BuildContext context) => DeleteAddressConfirmPage(
