...
class AddressHistoricDataPage extends StatelessWidget {
  ...
  const AddressHistoricDataPage({required this.id, required this.userid, super.key});
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ItemExtended(
                                    input: "User ID",
                                    title: state.info.userid.toString(),
                                    iconsrc: Icons.location_history_outlined,
                                    onTap: () => {
                                      Navigator.of(context).push(CupertinoPageRoute(
                                          builder: (BuildContext context) => UserDataPage(id: state.info.userid)))
                                    },
                                  ),
                                  ItemExtended(
                                    input: "Name",
