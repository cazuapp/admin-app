...
import 'package:cazuapp_admin/bloc/user/login/bloc.dart';
import 'package:cazuapp_admin/views/auth/header.dart';
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        ...
                        elevation: 0,
                        backgroundColor: state.isValid ? AppTheme.shallowlockeye : Colors.grey,
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(5.0),
                        ),
                      ),
