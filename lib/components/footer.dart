  ...
  Widget build(BuildContext context) {
    return SizedBox(
        ...
        child: ElevatedButton.icon(
          ...
          label: utext(
              title: "Home", fontSize: 16, color: AppTheme.white, align: Alignment.center, fontWeight: FontWeight.w500),
          ...
          onPressed: () {
            Navigator.of(context, rootNavigator: true).push(MaterialPageRoute(builder: (_) => const MenuPage()));
          },
        ));
  }
}
