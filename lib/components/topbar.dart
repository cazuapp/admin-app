  ...
  Widget build(BuildContext context) {
    return PopScope(
        ...
        child: AppBar(
          ...
          actions: <Widget>[
            InkWell(
                onTap: () => widget.self == false ? {navigate(context, const StorePage())} : null,
                child: Padding(
          ...
          leading: IconButton(
              icon: Icon(Navigator.of(context).canPop() ? FontAwesomeIcons.arrowLeftLong : FontAwesomeIcons.house,
                  size: 15, color: AppTheme.white),
              onPressed: () {
